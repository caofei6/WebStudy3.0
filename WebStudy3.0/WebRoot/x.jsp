		...
		<div class="m-right">
			<div class="right-nav">
					<ul>
							...
							<li>></li>
							<li><a href="student.jsp">选择题</a></li>
					</ul>
			</div>

		<div class="main"><br><br>
		<form method="post" action="question.action?type=x">
			<input class="ppb" type="submit" value="提交" />
		  <%
				JsonParser parse = new JsonParser();
				JsonArray array = parse.parse(sess.get("xquestion_list").toString()).getAsJsonArray();
		   ...
		   %>
			...
			<%
			String string = jo.get("question").toString().replace("\"", "").replace("\\r","\r").replace("\\n", "\n");
			String[] a = string.split("#");	
			 %>
	        <%=a[0] %>
	        <p><br>
            <p class="ppd">
			<input name="key" type="radio" value="" /><%=a[1]%> <br>
			<input name="key" type="radio" value="" /><%=a[2]%> <br>
			<input name="key" type="radio" value="" /><%=a[3]%> <br>
			<input name="key" type="radio" value="" /><%=a[4]%> <br>
			<p><br>
			<hr>
