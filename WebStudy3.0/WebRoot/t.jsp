			...
			<div class="right-nav">
					<ul>
							<li><a herf="admin.jsp"><img src="images/home.png"></a></li>
								...
								<li>></li>
								<li><a href="student.jsp">填空题</a></li>
						</ul>
			</div>

		<div class="main"><br><br>
		 <form method="post" action="question.action?type=t">
			<input class="ppb" type="submit" value="提交" />
		  <%
				JsonParser parse = new JsonParser();
				JsonArray array = parse.parse(sess.get("tquestion_list").toString()).getAsJsonArray();
				
				for(int i = 0; i < array.size(); i++){		
					JsonObject jo = array.get(i).getAsJsonObject();
					String queID = jo.get("queID").toString().replace("\"", "");
		   ...
		   %>
            ...
            <p><br>
             <input name="key" style="width:400px;margin:0 30%;font-size: 15px;" autofocus="autofocus"/>
