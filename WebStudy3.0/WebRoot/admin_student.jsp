	...
	<div id="header">
		...
		<div class="navigation">
			<ul>
				...
				<li><a href="update_password.jsp">修改密码</a>
				</li>
				<li><a href="settings.jsp">设置</a>
				</li>
		...
		<div class="m-right">
			<div class="right-nav">
				<ul>
					...
					<li><a href="admin.jsp">学生管理</a></li>
					<li>></li>
					<li><a href="admin_student.jsp">查看信息</a></li>
				</ul>
			</div>
			<div class="main">
				<div style="position:absolute;top:200px;left:700px;">
					<table style="text-align:center" border="3" bordercolor="#555555" width="800" cellpadding="0" cellpadding="0">
						<tr>
							<th bgcolor="#CCFFFF" width="10%">用户名</th>
							<th bgcolor="#CCFFFF" width="10%">身份</th>
							<th bgcolor="#CCFFFF" width="10%">姓名</th>
							<th bgcolor="#CCFFFF" width="10%">性别</th>
							<th bgcolor="#CCFFFF" width="20%">电话</th>
							<th bgcolor="#CCFFFF" width="30%">EMail</th>
							<th bgcolor="#CCFFFF" width="10%">操作</th>
						</tr>
						<%
				            JsonParser parse = new JsonParser();
				            JsonArray array = parse.parse(sess.get("student_list").toString()).getAsJsonArray();
						...
						<tr>
							...
							<td bgcolor="#CCFFCC">
								<form id="form" method="post" action="delete_student?id=<%=jo.get("userID" + i).toString().replace("\"","") %>">
